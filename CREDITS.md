...
| # | 上游 | 贡献 | 使用方式 | 许可 |
|---|---|---|---|---|
| 1 | **吴嘉文GW**（抖音 @吴嘉文GW + 其公开飞书知识库《项目无缝同步》提示词） | 「交接文档驱动」工作法：十板块活文档结构、开场/收尾双口令协议、「按文件接管，不按聊天记录接管」核心思想（`skills/handoff/` 模式 B） | 本地化改写（增补类型适配、反模式清单、收尾纪律） | 署名引用；原作者保留其原创内容的权利 |
...
- 各上游内容的版权归原作者所有；本仓库以 MIT 发布的**仅限**标注为「忆殇 × 小殇原创」的部分及上述已改写的衍生文本。
